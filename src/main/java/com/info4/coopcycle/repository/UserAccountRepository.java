...
public interface UserAccountRepository extends JpaRepository<UserAccount, Long> {
    ...
    @Query(value = "select distinct userAccount from UserAccount userAccount left join fetch userAccount.roles",
    ...
    @Query("select distinct userAccount from UserAccount userAccount left join fetch userAccount.roles")
    List<UserAccount> findAllWithEagerRelationships();

    @Query("select userAccount from UserAccount userAccount left join fetch userAccount.roles where userAccount.id =:id")
