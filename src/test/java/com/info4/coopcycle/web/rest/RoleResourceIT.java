...
import com.info4.coopcycle.domain.Role;
import com.info4.coopcycle.repository.RoleRepository;
...
public class RoleResourceIT {
    ...
    private static final RoleEnum DEFAULT_ROLE = RoleEnum.RESTAURANT_OWNER;
    private static final RoleEnum UPDATED_ROLE = RoleEnum.CUSTOMER;
