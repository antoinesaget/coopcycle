...
describe('Payment e2e test', () => {
  ...
  it('should load Payments', async () => {
    ...
    expect(await paymentComponentsPage.getTitle()).to.eq('glCoopcycleApp.payment.home.title');
  ...
  it('should load create Payment page', async () => {
    ...
    expect(await paymentUpdatePage.getPageTitle()).to.eq('glCoopcycleApp.payment.home.createOrEditLabel');
  ...
  it('should create and save Payments', async () => {
    ...
    await promise.all([
      ...
      paymentUpdatePage.courseSelectLastOption()
    ]);
  ...
  it('should delete last Payment', async () => {
    ...
    expect(await paymentDeleteDialog.getDialogTitle()).to.eq('glCoopcycleApp.payment.delete.question');
