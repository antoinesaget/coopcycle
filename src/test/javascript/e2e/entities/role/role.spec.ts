...
describe('Role e2e test', () => {
  ...
  it('should load Roles', async () => {
    ...
    expect(await roleComponentsPage.getTitle()).to.eq('glCoopcycleApp.role.home.title');
  ...
  it('should load create Role page', async () => {
    ...
    expect(await roleUpdatePage.getPageTitle()).to.eq('glCoopcycleApp.role.home.createOrEditLabel');
  ...
  it('should create and save Roles', async () => {
    ...
    await promise.all([roleUpdatePage.roleSelectLastOption()]);
  ...
  it('should delete last Role', async () => {
    ...
    expect(await roleDeleteDialog.getDialogTitle()).to.eq('glCoopcycleApp.role.delete.question');
