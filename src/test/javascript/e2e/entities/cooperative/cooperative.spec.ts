...
describe('Cooperative e2e test', () => {
  ...
  it('should load Cooperatives', async () => {
    ...
    expect(await cooperativeComponentsPage.getTitle()).to.eq('glCoopcycleApp.cooperative.home.title');
    await browser.wait(
  ...
  it('should load create Cooperative page', async () => {
    ...
    expect(await cooperativeUpdatePage.getPageTitle()).to.eq('glCoopcycleApp.cooperative.home.createOrEditLabel');
  ...
  it('should create and save Cooperatives', async () => {
    ...
    await promise.all([
      ...
      cooperativeUpdatePage.setGeographicalAreaInput('geographicalArea'),
    ...
    expect(await cooperativeUpdatePage.getGeographicalAreaInput()).to.eq(
      'geographicalArea',
      'Expected GeographicalArea value to be equals to geographicalArea'
    );
  ...
  it('should delete last Cooperative', async () => {
    ...
    expect(await cooperativeDeleteDialog.getDialogTitle()).to.eq('glCoopcycleApp.cooperative.delete.question');
